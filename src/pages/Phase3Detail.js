...
const Phase3Detail = () => {
  ...
  const techStack = [
    { key: 'docker',    icon: '/images/docker.svg',    color: '#0db7ed', number: 1, isImg: true  },
    { key: 's3',        icon: '/images/s3.svg',        color: '#FF9900', number: 2, isImg: true  },
    { key: 'snowflake', icon: '/images/snowflake.png', color: '#29B5E8', number: 3, isImg: true  },
    { key: 'ec2',       icon: '/images/aws.svg',       color: '#FF9900', number: 4, isImg: true  },
    { key: 'airflow',   icon: '/images/airflow.png',   color: '#017CEE', number: 5, isImg: true  }
  ];
