...
const Home = () => {
  ...
  const techStack = [
    { name: 'AWS EC2', logo: '/images/aws.svg', color: '#FF9900', description: 'Cloud Computing' },
    { name: 'Amazon S3', logo: '/images/s3.svg', color: '#569A31', description: 'Data Lake Storage' },
    { name: 'Snowflake', logo: '/images/snowflake.png', color: '#29B5E8', description: 'Data Warehouse' },
    { name: 'Apache Airflow', logo: '/images/airflow.png', color: '#017CEE', description: 'Workflow Orchestration' },
    { name: 'dbt', logo: '/images/dbt.png', color: '#FF694B', description: 'Data Transformation' },
    { name: 'Power BI', logo: '/images/powerbi.svg', color: '#F2C811', description: 'Data Visualization' },
    { name: 'Docker', logo: '/images/docker.svg', color: '#2496ED', description: 'Containerization' },
    { name: 'Python', logo: '/images/python.svg', color: '#3776AB', description: 'Programming Language' }
  ];

  const architectureSteps = [
    { name: 'CSV', logo: null, label: 'Source Data', emoji: '📄' },
    { name: 'Amazon S3', logo: '/images/s3.svg', label: t('architecture.dataLake') },
    { name: 'Snowflake', logo: '/images/snowflake.png', label: t('architecture.rawLayer') },
    { name: 'dbt', logo: '/images/dbt.png', label: t('architecture.transform') },
    { name: 'Power BI', logo: '/images/powerbi.svg', label: t('architecture.dashboard') }
  ];

  const learningTopics = [
    { key: 'cloud', icon: '/images/aws.svg', color: '#FF9900' },
    { key: 'orchestration', icon: '/images/airflow.png', color: '#017CEE' },
    { key: 'warehouse', icon: '/images/snowflake.png', color: '#29B5E8' },
    { key: 'transform', icon: '/images/dbt.png', color: '#FF694B' },
    { key: 'modeling', icon: '/images/snowflake.png', color: '#9B59B6' }
  ];
    ...
    <div style={styles.container}>
      ...
      >
        ...
        <div style={styles.prerequisitesList}>
          {[
            { icon: '/images/aws.svg', text: t('prerequisites.item1') },
            { icon: '/images/snowflake.png', text: t('prerequisites.item2') },
            { emoji: '💻', text: t('prerequisites.item3') },
            { icon: '/images/python.svg', text: t('prerequisites.item4') }
          ].map((item, index) => (
